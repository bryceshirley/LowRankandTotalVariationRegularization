function XRecovered = Algorithm2_Tensor(XCorrupted,P,mu,kmax,tol1,tol2,alpha)
...
while alphak > tol2
    [X] = Algorithm1_Tensor(X0, XCorrupted, P, lambda1*(alphak*5e-2),lambda2*(alphak*5e-2), mu,kmax,tol1);
    alphak = alpha*alphak;
    X0 = X;
    figure(1)
    subplot(1,3,1)
