function [M,Omega] = SpiralSampleFull(file_name)
% Function randomly samples each image in tensor to a specified ratio.
% Where the sampler uses spiral with a contanst velocity which isthe random 
% variable.
...
for i=1:n_E
    ...
    [sample_matrix,sample_image,~] = SpiralSampler(image_matrix,approx_sample_ratio);
